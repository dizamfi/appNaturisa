      ...
      child: PopScope(
        ...
        child: Scaffold(
          ...
          body: Consumer<PiscinasJosefinaProvider>(
            ...
            } else if (ebProvider.apiDataListPC106.isEmpty) {
              // Mostrar mensaje de que no hay datos
              // return const ShimmerLoading();
            }

            // Verificar si apiDataList contiene solo arreglos vacíos
            bool contieneSoloArreglosVacios =
                Piscina.contieneSoloArreglosVacios(apiDataList);
                                  ...
                                  Container(
                                    ...
                                    child: SlideShow(
                                      ...
                                      slides: [
                                        ...
                                        // Agrega un widget de sustitución default en caso de que no haya datos válidos
                                        apiDataList.isNotEmpty &&
                                            ...
                                            : Container(
                                                ...
                                                child: const Text(
                                                    'No hay datos disponibles para Control Remoto'),
                                              ),
                                        ...
                                        apiDataList.isNotEmpty &&
                                            ...
                                            : Container(
                                                alignment: Alignment.center,
                                                child: const Text(
                                                    'No hay datos disponibles para Información General'),
                                              ),
                                      ],
                                    ),
                                  ),
